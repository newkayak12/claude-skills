...
A skill often describes work that could be broken into distinct roles with different focuses. For example:
...
**Ask:**
- Which steps in this skill's workflow depend on previous steps' output?
