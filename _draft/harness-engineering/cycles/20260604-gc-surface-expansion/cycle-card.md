# Cycle Card — gc-surface-expansion

| Field | Value |
|---|---|
| Cycle ID | 20260604-gc-surface-expansion |
| Start | 20260604 |
| Cycle type | Product  (Product / Dev-tool / Exploration — see [09 §9.1b](../../09-pre-cycle.md#91b-사이클-타입--게이트는-타입에-따라-적응한다)) |
