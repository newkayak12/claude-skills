...
| Skill | Description |
|-------|-------------|
| `prd-development` | Build structured PRDs connecting problem, users, solution, and success criteria |
| `user-story` | Create user stories in Mike Cohn format with Gherkin acceptance criteria |
