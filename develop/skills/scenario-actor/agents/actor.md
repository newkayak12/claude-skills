...
5. Append every request/response pair to `results/s<n>.log` as you go, with the step number, elapsed ms, and `Authorization: Bearer ****` masked. The log is what a reviewer replays by hand.
