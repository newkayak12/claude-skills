...
- **9-10:** Weekly cadence, employee sets agenda, coaching questions dominate, consistent follow-through, growth is tracked
- **7-8:** Regular cadence but manager-led; project status dominates; follow-through is inconsistent
- **5-6:** Meetings happen but are unstructured; no agenda; employee is passive; growth rarely discussed
- **3-4:** Meetings are irregular or frequently cancelled; primarily status updates; no follow-through system
- **1-2:** 1-on-1s rarely happen; employee growth is not tracked; trust is low or unknown

## The 1-on-1 Manager Framework
...
**Key insights:**
- Weekly 30-45 minutes beats biweekly 60 minutes — frequency enables timelier support
- Same time, same day — reduce scheduling friction; make it non-negotiable
- Never cancel; always reschedule if necessary — model that this is a priority
- The employee should arrive knowing the agenda; the manager should arrive having reviewed the last session's notes
- Remote-first tip: video on, no multitasking, treat it as the most focused meeting of the week
- First 1-on-1 with a new report: invest full time in getting-to-know-you, not tasks
...
**Key insights:**
- Shared Google Doc or Notion page: employee adds topics; manager adds topics; both can see in advance
- "I don't have anything" is not an acceptable agenda — coach the employee to think about: what's blocking you? what do you want to learn? what feedback do you want? what's on your mind?
- If the employee comes with no agenda for several weeks, that is a signal worth investigating
- Manager items should be added at the bottom — they get time if employee topics are covered
- Status updates should be redirected: "You can update me on that in the project channel — what would you like to talk about?"
- The agenda doc becomes the memory of the relationship — track decisions and follow-through items
...
**Key insights:**
- "What do you think?" is the most powerful sentence in a manager's vocabulary
- Follow-up: "What have you tried?" → "What did you learn?" → "What would you do differently?"
- Avoid leading questions: "Don't you think you should...?" is advice disguised as a question
- Silence is a tool: after asking a question, wait. The employee will fill the silence with real thinking.
- The GROW model: Goal (what do you want?) → Reality (what's happening now?) → Options (what could you do?) → Will (what will you do?)
- When to shift from coaching to advising: "I have a perspective on this — would you like to hear it?" — then get consent
...
**Key insights:**
- Ask in early 1-on-1s: "Where do you want to grow? What kind of work energizes you?"
- Document the answer: a shared growth note or section in the 1-on-1 doc
- Revisit quarterly: "Is this still where you want to grow? Has anything changed?"
- Sponsorship > mentorship: don't just coach — create opportunities, make introductions, advocate in rooms the employee isn't in
- Stretch assignments: "I want to give you the chance to lead the next architecture review — here's why I think you're ready, and here's how I'll support you"
- Skill gaps should be specific: "You want to grow in technical leadership — the gap I see is structuring technical proposals. Here's how we'll work on that."
...
**Key insights:**
- Timely feedback: as close to the event as possible, ideally within 48 hours
- Specific feedback: "The way you structured the incident post-mortem made the root cause clear and the action items actionable — that's the bar" not "Good job on the post-mortem"
- Developmental feedback: "The area where I'd like to see you grow is..." not "You're bad at..."
- Upward feedback: "I'm trying to get better at [X] — what's one thing I could do differently?"
- Psychological safety: feedback requires safety — if the employee is afraid of the reaction, feedback won't flow
- Trust is built by: doing what you say you'll do, being honest when you don't know, advocating for the employee's interests in rooms they're not in
