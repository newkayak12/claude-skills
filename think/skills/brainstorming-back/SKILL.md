---
name: brainstorming-back
description: >-
  Use when the user explicitly asks for `brainstorming-back` — the pre-rewrite backup of
  brainstorming, kept for side-by-side comparison. Never triggers on its own.
scenarios:
